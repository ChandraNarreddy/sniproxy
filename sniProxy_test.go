...
func TestSniProxy(t *testing.T) {
	...
	for _, ver := range minTLSver {
		...
		testURIMaps[http.StatusTemporaryRedirect] = append(testURIMaps[http.StatusTemporaryRedirect], "/authFailure/")
		testURIMaps[http.StatusTemporaryRedirect] = append(testURIMaps[http.StatusTemporaryRedirect], "/WrongTokenType/")
		testURIMaps[http.StatusTemporaryRedirect] = append(testURIMaps[http.StatusTemporaryRedirect], "/AuthCheckError/")
